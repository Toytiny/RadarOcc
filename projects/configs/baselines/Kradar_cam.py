...
train_ann_file = "/home/xiangyu/SurroundOcc/kradar_os32_dict_train.pkl"
val_ann_file = "/home/xiangyu/SurroundOcc/adv_weather.pkl"
depth_gt_path = '/mnt/data/DataSet/K-RadarOOC/depth_gt'
...
occ_size = [128, 128, 14]
lss_downsample = [1, 1, 1]  # [128 128 10]
...
grid_config = {
    'xbound': [-25.6, 25.6, voxel_x*lss_downsample[0]],
