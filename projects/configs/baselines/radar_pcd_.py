...
train_ann_file = "/home/xiangyu/SurroundOcc/kradar_rpc_dict_train.pkl"
val_ann_file = "/home/xiangyu/SurroundOcc/kradar_rpc_dict_test.pkl"
# For nuScenes we usually do 10-class detection
class_names = LIST_CLS_NAME = [
    'Static',
    'Sedan',
    'Bus or Truck'] 
point_cloud_range = [-25.6, -25.6, -2.6, 25.6, 25.6, 3.0] #x have been moved during loading
occ_size = [128, 128, 14]
...
model = dict(
    ...
    pts_middle_encoder=dict(
        ...
        sparse_shape_xyz=[1024, 1024, 112],  # hardcode, xy size follow centerpoint
        ),
