...
train_ann_file = "/home/xiangyu/SurroundOcc/kradar_dict_train.pkl"
val_ann_file = "/home/xiangyu/SurroundOcc/kradar_dict_val.pkl"
...
model = dict(
    ...
    pts_middle_encoder=dict(
        type='SparseRaDAREnc2x',
        input_channel=4,
        base_channel=16,
        out_channel=numC_Trans,
        norm_cfg=dict(type='SyncBN', requires_grad=True),
        sparse_shape_xyz=[256, 256, 20],  
        ),
...
train_pipeline = [
    dict(type='LoadRadarcube', to_float32=True
        ),
    ...
    dict(type='Collect3D', keys=['gt_occ', 'rdr_cube']),
]
