...
class RadarDopplerAttnEA(BEVDepth):
    def __init__(self, 
            loss_cfg=None,
    ...
    def extract_pts_feat(self, rdr_cube):
        ...
        _,_, h,w,z=spherical_feat.shape()
        # h,w,z = [54, 128, 19]
        ...
        sph_ref_3d = self.get_reference_points_spherical(device=spherical_feat.device,spherical_shape=[ h,w,z],scale=4)
    ...
    def simple_test(self, img_metas, img=None, points=None, rescale=False, points_occ=None, 
        ...
        SC_metric, _ = self.evaluation_semantic(pred_c, target_voxels, eval_type='SC', visible_mask=visible_mask)
        SSC_metric, SSC_occ_metric = self.evaluation_semantic(pred_c, target_voxels, eval_type='SSC', visible_mask=visible_mask)
